...
class PrestamosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prestamo" do
    assert_difference('Prestamo.count') do
      post prestamos_url, params: { prestamo: { fechaDevolucion: @prestamo.fechaDevolucion, fechaPrestamo: @prestamo.fechaPrestamo, nombreAutor: @prestamo.nombreAutor, nombreCliente: @prestamo.nombreCliente, nombreLibro: @prestamo.nombreLibro } }
    end
  ...
  test "should update prestamo" do
    patch prestamo_url(@prestamo), params: { prestamo: { fechaDevolucion: @prestamo.fechaDevolucion, fechaPrestamo: @prestamo.fechaPrestamo, nombreAutor: @prestamo.nombreAutor, nombreCliente: @prestamo.nombreCliente, nombreLibro: @prestamo.nombreLibro } }
